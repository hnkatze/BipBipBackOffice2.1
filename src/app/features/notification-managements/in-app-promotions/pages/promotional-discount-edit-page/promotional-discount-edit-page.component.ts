...
import { UpdatePromotionalDiscount, PromotionalDiscountResponse, DiscountType, DISCOUNT_TYPE_OPTIONS } from '../../models/promotional-discount.model';
import { GlobalDataService } from '@core/services/global-data.service';

@Component({
  selector: 'app-promotional-discount-edit-page',
  imports: [
    CommonModule,
    ReactiveFormsModule,
    CardModule,
  ...
  templateUrl: './promotional-discount-edit-page.component.html',
  styleUrl: './promotional-discount-edit-page.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class PromotionalDiscountEditPageComponent implements OnInit {
